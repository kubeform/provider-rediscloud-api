...
import (
	v1alpha1 "kubeform.dev/provider-rediscloud-api/client/clientset/versioned/typed/subscription/v1alpha1"
...
func (c *FakeSubscriptionV1alpha1) Peerings(namespace string) v1alpha1.PeeringInterface {
