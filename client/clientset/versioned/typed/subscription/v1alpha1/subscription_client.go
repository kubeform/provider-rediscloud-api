...
// SubscriptionV1alpha1Client is used to interact with features provided by the subscription.rediscloud.kubeform.com group.
type SubscriptionV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SubscriptionV1alpha1Client) Peerings(namespace string) PeeringInterface {
