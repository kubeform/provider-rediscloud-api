...
import (
	...
	v1alpha1 "kubeform.dev/provider-rediscloud-api/client/listers/subscription/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SubscriptionV1alpha1().Peerings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SubscriptionV1alpha1().Peerings(namespace).Watch(context.TODO(), options)
			},
		},
		&subscriptionv1alpha1.Peering{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *peeringInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&subscriptionv1alpha1.Peering{}, f.defaultInformer)
}
